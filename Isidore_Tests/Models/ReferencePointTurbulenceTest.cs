...
namespace Isidore_Tests
{
    ...
    class ReferencePointTurbulenceTest
    {
        ...
        public static bool Run()
        {
            ...
            var pts0 = new List<Point>(2);
            pts0.Add(turbPt);
            pts0.Add(turbPt3);
            var pts1 = new List<Point>(2);
            pts1.Add(turbPt2);
            pts1.Add(turbPt4);
            // Adds turbulence points to each reference list
            ...
            var pos5 = new Point(len0 * separation[0] / 2.0, 0,
                0); // Point position
            var pos6 = new Point(len0 * separation[0] / 2.0,
                len1 * separation[1], 0); // Point position
            // Point lists
            var p5list = new List<Point>(2);
            p5list.Add(refPt);
            p5list.Add(refPt4);
            var p6list = new List<Point>(2);
            p6list.Add(refPt3);
            p6list.Add(refPt2);
            var refPt5 = new ReferencePoint(pos5.Comp, p5list, 
                ReferencePoint.Category.Interpolation);
            var refPt6 = new ReferencePoint(pos6.Comp, p6list,
                ReferencePoint.Category.Interpolation);
            refPts.Add(refPt5);
            refPts.Add(refPt6);
            ...
            /////////////////////////////////////////////////
            var polynom = new SmoothStep(6);
            var turbulence = new ReferencePointTurbulence(refPts, polynom);
