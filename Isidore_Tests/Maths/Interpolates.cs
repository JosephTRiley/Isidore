...
namespace Isidore_Tests
{
    class Interpolates
    {
        public static bool Run()
        {
            ...
            for (int idx = 0; idx < totPts; idx++)
                intArr[idx] = Interpolate.Linear(intPts[idx], arrPts, arrVals);
            ...
            matlab.Execute("legend('Keys','Interp Vals','Trans Vals','Location','Best')");
            matlab.Execute("save Interpolates.mat; mkBold(0)");
            matlab.Execute("printFig('LinInterpTest'); Convert2pdf; delete *.eps;");
